...
<template>
    ...
    <div class="elevator-panel__indicators">
        ...
        <div v-if="designatedDirection === DesignatedDirectionEnum.DESIGNATED_UP"
            class="elevator-panel__direction-indicator elevator-panel__direction-indicator--up"></div>
        <div v-if="designatedDirection === DesignatedDirectionEnum.DESIGNATED_DOWN"
            class="elevator-panel__direction-indicator elevator-panel__direction-indicator--down"></div>
        <div v-if="designatedDirection === DesignatedDirectionEnum.IDLE" class="elevator-panel__direction-indicator">
        </div>
    </div>
    <div class="elevator-panel__floor-buttons">
        <button @click="onChooseFloor(floor)" v-for="floor in floorNumbers" class="button elevator-panel__floor-button"
            :class="{
